...
export class PaisesComponent {
    ...
    canView : boolean = this.loginService.havePermission('Pode_Visualizar_Paises');
    canRegister: boolean = this.loginService.havePermission('Pode_Criar_Paises');
	...
	novoRegistro(): void {
        ...
        if (this.canRegister){
		    this.router.navigate(['/app/paises/create']);
        }
	}
